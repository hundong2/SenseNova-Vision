# SenseNova-Vision Archify Architecture
...
- Repository URL: https://github.com/hundong2/SenseNova-Vision.git
- Checkout SHA: 5ebf42cbebe0334a626d4ea2d4bb90cdfb55a85d
- README file: README_CN.md
- Evidence file: README_CN.md
- README title: SenseNova-Vision: Vision as Unified Multimodal Generation
- Dependency markers: Python deps
- Top-level directories: assets, data, docs, examples, inference, modeling, scripts
- Category: Vision and perception

## 적용 프롬프트

~~~~text
Use Archify to create a high-level architecture diagram for SenseNova-Vision.
...
주 경로는 `Developer / learner -> README and docs -> Setup and deps -> Entry points -> Model / vision core -> Predictions / artifacts`이다.
